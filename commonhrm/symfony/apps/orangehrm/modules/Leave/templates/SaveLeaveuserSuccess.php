 ...
 ?>
                ...
                <div class="centerCol" style="padding-left: 300px;" id="divbtn">
                    <input type="submit" class="savebutton" id="editBtn1" onclick="defaultdata();"
                           value="<?php echo __("OK") ?>" tabindex="8" />
                    <br class="clear">
                </div>
                ...
                <div class="leftCol" style="width:400px;" >
                    ...
                    <div id="tabel1" style="float: left;" >
                        ...
                        <div class="centerCol" style="padding-top: 8px;">
                            <input id="txtLeaveStartDate" type="text" name="txtLeaveStartDate" value="" onchange="txtenable(this.value);">
                        </div>
                        <br class="clear"/>
                        <div id="DIVEDAY" style=" width: 350px;">
                            ...
                            <div class="centerCol" style="padding-top: 8px;">
                                <input id="txtLeaveEndDate" type="text" name="txtLeaveEndDate" value="" onchange="getday($('#txtLeaveStartDate').val(),this.value);">
                            </div>
                            <br class="clear"/>
                        </div>
                        <div class="leftCol" >
