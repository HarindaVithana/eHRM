...
class EmployeeService extends BaseService {
    ...
    public function savePersonalDetails(Employee $employee) {
        $conn = Doctrine_Manager :: connection();
        $conn->beginTransaction();
...
//
    ...
    public function getEmployeeList($searchMode, $searchValue, $userCulture="en", $page=1, $orderField = 'emp_number', $orderBy = 'ASC') {
        return $this->employeeDao->getEmployeeList($searchMode, $searchValue, $userCulture, $page, $orderField, $orderBy);
    }
