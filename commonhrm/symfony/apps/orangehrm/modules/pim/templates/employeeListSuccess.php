 ...
 function showPage(page){
     ...
     //pager.showPage(10);
        ...
        childdiv="";
            ...
            data: { datapage: (page1) , searchmode: $('#cmbSearchMode').val() , searchvalue: $('#txtSearchValue').val(), sort:sort},
            dataType: "json",
     ...
     var rows = $("#PageRows").val();
        if(rows!=0){
        var records = (rows - 1); 
        this.pages = Math.ceil(records / 15);
        this.inited = true;
        }
        var pager = new Pager('results', 15); 
        ...
        var page=end-1;
        var pagerHtml = '<span onclick="showPage(1);" class="pg-normal"> <?php echo __("First") ?> </span> <span onclick="pager.prev();" class="pg-normal"> <?php echo __("Prev") ?> </span> | ';
        ...
        for (var page = pos; page <= end; page++){ 
            ...
            pagerHtml += '<span id="pg' + page + '" class="pg-normal" >' + page + '</span> | ';
            }
       // pagerHtml += '<span onclick="'+pagerName+'.next();" class="pg-normal"> <?php echo __("Next")?> &#187;</span>'; 
         pagerHtml += '<span onclick="showPage(0);" class="pg-normal"> <?php echo __("Last")?> </span>';
...
//        }
    ...
    this.showPageNav = function(pagerName, positionId) {
       ...
       // pagerHtml += '<span onclick="'+pagerName+'.next();" class="pg-normal"> <?php echo __("Next")?> &#187;</span>'; 
         pagerHtml += '<span onclick="'+pagerName+'.next();" class="pg-normal"> <?php echo __("Next")?> </span><span onclick="showPage(0);" class="pg-normal"> <?php echo __("Last")?> </span>';
